...
@summary  Interface class for any TAF environment configuration entry.
"""
...
class GenericEntry(object, metaclass=ABCMeta):
    """
    @description  Interface class for any TAF environment configuration entry.
    """
    ...
    def __init__(self, config, opts):
        """
        @brief  Entry __init__ method has to take 2 parameters.
    ...
    def create(self):
        """
        @brief  Called on environment initialize step. It should contain any steps necessary to start using device instance.
        """
        pass
    ...
    def destroy(self):
        """
        @brief  Called on environment shutdown step. It should contain any necessary steps to release used device.
        """
        pass
    ...
    def check(self):
        """
        @brief  Called in environment check method. Used before/after TC to verify that environment is ready to use.
        """
        pass
    ...
    def sanitize(self):
        """
        @brief  Called in environment sanitize method. It's used by pytest.softexit and should contain any steps to release possible locks.
        """
        pass
    ...
    def cleanup(self):
        """
        @brief  Called in environment cleanup method. It's used to delete all runtime configuration and return entry to default state.
        """
        pass

    def start(self):
        """
        @brief  This method could be called by create method and has to prepare entry object for processing commands.
    ...
    def stop(self):
        """
        @brief  This method could be called by destroy method and has to release entry object configuration.
