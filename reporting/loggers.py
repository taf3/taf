...
# Logging levels
# Obsolete style
levels = {'CRITICAL': logging.CRITICAL, 'FATAL': logging.FATAL, 'ERROR': logging.ERROR, 'WARNING': logging.WARNING,
          'WARN': logging.WARN, 'INFO': logging.INFO, 'DEBUG': logging.DEBUG, 'NOTSET': logging.NOTSET, "TRACE": logging.TRACE}
...
class ClassLogger(object):
    ...
    def __init__(self, log_level=LOG_LEVEL, log_file=LOG_FILENAME, log_stream=LOG_STREAM, for_exception=False, introspection=True):
        """
        @brief  Initialize ClassLogger class
        """
        self._logger = None
