...
@summary  Logger functionality demo test suite.
...
@note  HowTo:
       ...
       Note: --logdir is mandatory option to check sshlog functionality. If you don't set logdir only stdout logger will be configured.
...
class TestSSHLogger(object):
    """
    @brief  This suite demonstrates autolog and sshlog fixtures usage.
    """
